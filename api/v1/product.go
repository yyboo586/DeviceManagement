...
type DeleteProductReq struct {
	g.Meta `path:"/products" tags:"产品管理" method:"delete" summary:"删除"`
...
type GetProductReq struct {
	g.Meta `path:"/products/{id}" tags:"产品管理" method:"get" summary:"详情"`
	ID     int64 `p:"id" v:"required#产品ID不能为空" dc:"产品ID"`
}
...
type ListProductReq struct {
	g.Meta     `path:"/products" tags:"产品管理" method:"get" summary:"列表"`
	OrgID      string `json:"org_id" v:"required#组织ID不能为空" dc:"组织ID"`
