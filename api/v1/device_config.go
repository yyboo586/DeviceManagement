...
type AddDeviceConfigReq struct {
	g.Meta `path:"/devices/config" tags:"设备管理/配置管理" method:"post" summary:"添加设备告警配置"`
	model.Author
...
type DeleteDeviceConfigReq struct {
	g.Meta `path:"/devices/config/{id}" tags:"设备管理/配置管理" method:"delete" summary:"删除设备告警配置"`
	model.Author
...
type EditDeviceConfigReq struct {
	g.Meta `path:"/devices/config/{id}" tags:"设备管理/配置管理" method:"put" summary:"编辑设备告警配置"`
	model.Author
	ID     int64   `p:"id" v:"required#配置ID不能为空" dc:"配置ID"`
...
type GetDeviceConfigListReq struct {
	g.Meta `path:"/devices/config" tags:"设备管理/配置管理" method:"get" summary:"获取设备告警配置"`
	model.Author
	OrgID string `json:"org_id" v:"required#组织ID不能为空" dc:"组织ID"`
	Type  string `json:"type" v:"required|in:alarm#配置类型不能为空" dc:"配置类型"`
}

type GetDeviceConfigListRes struct {
	g.Meta `mime:"application/json"`
